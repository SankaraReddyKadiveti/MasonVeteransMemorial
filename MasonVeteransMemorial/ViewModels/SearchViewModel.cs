...
namespace MasonVeteransMemorial.ViewModels
{
    ...
    public class SearchViewModel : BaseViewModel
    {
        ...
        public AppCommand SearchCommand => new AppCommand(async () => await Search(SearchText));
        public AppCommand ResetSearchCommand => new AppCommand(ResetSearch);
        public AppCommand LocateBrickCommand => new AppCommand(LocateBrick);
