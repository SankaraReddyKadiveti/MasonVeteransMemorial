...
namespace MasonVeteransMemorial.Pages
{
    public partial class SkiaToolsPage : ContentPage
    {
        ...
        public SkiaToolsPage()
        {
            ...
            var path = "MasonVeteransMemorial.Data.drone_pu_4_overhead_view.png";

            if (!IS_HONOR_ROLL_IMAGE)
                path = "MasonVeteransMemorial.Data.drone_pu_4_overhead_view.png";
            ...
            Title = "Tools";
            Icon = "ic_map";
            btnImgSelect.BackgroundColor = Color.Lime;
            ...
            btnShowHideMap.Clicked += (obj, args) =>
            {
                ...
                if (canvasLayoutMap.IsVisible)
                {
                    ...
                    btnShowHideMap.TextColor = Color.Red;
                }
                else
                {
                    btnShowHideMap.Text = "!Map";
                    btnShowHideMap.TextColor = Color.Green;
                }
            };
            ...
            btnShowHideImage.Clicked += (obj, args) =>
            {
                ...
                if (canvasLayout.IsVisible)
                {
                    ...
                    btnShowHideImage.TextColor = Color.Red;
                }
                else
                {
                    btnShowHideImage.Text = "!Img";
                    btnShowHideImage.TextColor = Color.Green;
                }
            };
            ...
            btnShowHideTImage.Clicked += (obj, args) =>
            {
                ...
                if (canvasLayoutTImage.IsVisible)
                {
                    ...
                    btnShowHideTImage.TextColor = Color.Red;
                }
                else
                {
                    btnShowHideTImage.Text = "!TImg";
                    btnShowHideTImage.TextColor = Color.Green;
                }
            };
            ...
            btnShowHideTCanvas.Clicked += (obj, args) =>
            {
                ...
                if (canvasLayoutTCanvas.IsVisible)
                {
                    ...
                    btnShowHideTCanvas.TextColor = Color.Red;
                }
                else
                {
                    btnShowHideTCanvas.Text = "!TCvs";
                    btnShowHideTCanvas.TextColor = Color.Green;
                }
            };
            ...
            btnEnableFingerToggle.Clicked += (obj, args) =>
            {
                ...
                if (!isUseFingerPaint)
                {
                    ...
                    btnEnableFingerToggle.TextColor = Color.Green;
                }
                else
                {
                    btnEnableFingerToggle.Text = "xFing";
                    btnEnableFingerToggle.TextColor = Color.Red;
                }
            };
        ...
        //***** BITMAP
        protected void skCanvas_OnPaintSurface(object sender, SkiaSharp.Views.Forms.SKPaintSurfaceEventArgs e)
        {
            var info = e.Info;
        ...
        //***** GRID ********//
        protected void skCanvasGrid_OnPaintSurface(object sender, SkiaSharp.Views.Forms.SKPaintSurfaceEventArgs e)
        {
            var info = e.Info;
            var surface = e.Surface;
            var canvas = surface.Canvas;
        ...
        void OnBtnImgSelectClicked(object sender, System.EventArgs e)
        {
            ...
            btnImgSelect.BackgroundColor = Color.Lime;
            btnMapSelect.BackgroundColor = Color.Transparent;
            btnTImgSelect.BackgroundColor = Color.Transparent;
        }
        ...
        void OnBtnMapSelectClicked(object sender, System.EventArgs e)
        {
            ...
            Title = "Map Settings";
            btnImgSelect.BackgroundColor = Color.Transparent;
            btnTImgSelect.BackgroundColor = Color.Transparent;
            btnMapSelect.BackgroundColor = Color.Lime;
        }
        ...
        void OnBtnTImgSelectClicked(object sender, System.EventArgs e)
        {
            ...
            btnImgSelect.BackgroundColor = Color.Transparent;
            btnMapSelect.BackgroundColor = Color.Transparent;
            btnTImgSelect.BackgroundColor = Color.Lime;
        }
